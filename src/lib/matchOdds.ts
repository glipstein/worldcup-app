...
//
// Last fetched: 2026-06-15T20:44:15.308Z
// Match markets: 38 / 99
 ...
 * 38 markets fetched on 2026-06-15T20:44:15.308Z.
 */
export const MATCH_ODDS: Record<string, MatchOdds> = {
  ...
  BEL_EGY: { pHome: 0.3970, pDraw: 0.4573, pAway: 0.1457 },
  ...
  ESP_KSA: { pHome: 0.8875, pDraw: 0.0744, pAway: 0.0382 },
  FRA_IRQ: { pHome: 0.8758, pDraw: 0.0940, pAway: 0.0302 },
  ...
  JPN_SWE: { pHome: 0.4428, pDraw: 0.2836, pAway: 0.2736 },
  KSA_URU: { pHome: 0.1144, pDraw: 0.2139, pAway: 0.6716 },
  MAR_HAI: { pHome: 0.7438, pDraw: 0.1626, pAway: 0.0936 },
  ...
  URU_CPV: { pHome: 0.6683, pDraw: 0.2060, pAway: 0.1256 },
...
export const MATCH_ODDS_FETCHED_AT = '2026-06-15T20:44:15.308Z';
