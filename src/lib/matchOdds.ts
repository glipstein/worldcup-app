...
//
// Last fetched: 2026-06-12T02:28:27.636Z
// Match markets: 38 / 99
 ...
 * 38 markets fetched on 2026-06-12T02:28:27.636Z.
 */
export const MATCH_ODDS: Record<string, MatchOdds> = {
  ...
  BEL_IRN: { pHome: 0.6850, pDraw: 0.2000, pAway: 0.1150 },
  BIH_QAT: { pHome: 0.5879, pDraw: 0.2563, pAway: 0.1558 },
  BRA_MAR: { pHome: 0.5879, pDraw: 0.2462, pAway: 0.1658 },
  CAN_BIH: { pHome: 0.5224, pDraw: 0.2637, pAway: 0.2139 },
  CAN_QAT: { pHome: 0.7413, pDraw: 0.1741, pAway: 0.0846 },
  CIV_ECU: { pHome: 0.2663, pDraw: 0.3367, pAway: 0.3970 },
  CZE_RSA: { pHome: 0.5879, pDraw: 0.2362, pAway: 0.1759 },
  ECU_GER: { pHome: 0.1921, pDraw: 0.2512, pAway: 0.5567 },
  ENG_GHA: { pHome: 0.7376, pDraw: 0.1634, pAway: 0.0990 },
  ESP_CPV: { pHome: 0.9018, pDraw: 0.0673, pAway: 0.0309 },
  ESP_KSA: { pHome: 0.8719, pDraw: 0.0847, pAway: 0.0433 },
  FRA_IRQ: { pHome: 0.8698, pDraw: 0.0955, pAway: 0.0347 },
  ...
  NED_JPN: { pHome: 0.4778, pDraw: 0.2709, pAway: 0.2512 },
...
export const MATCH_ODDS_FETCHED_AT = '2026-06-12T02:28:27.636Z';
