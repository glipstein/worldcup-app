...
//
// Last fetched: 2026-06-18T20:09:21.781Z
// Match markets: 38 / 99
 ...
 * 38 markets fetched on 2026-06-18T20:09:21.781Z.
 */
export const MATCH_ODDS: Record<string, MatchOdds> = {
  ...
  FRA_IRQ: { pHome: 0.8926, pDraw: 0.0756, pAway: 0.0318 },
  ...
  NED_SWE: { pHome: 0.5578, pDraw: 0.2462, pAway: 0.1960 },
  NOR_FRA: { pHome: 0.2217, pDraw: 0.2414, pAway: 0.5369 },
  PAN_ENG: { pHome: 0.0945, pDraw: 0.1343, pAway: 0.7711 },
  QAT_SUI: { pHome: 0.0000, pDraw: 1.0000, pAway: 0.0000 },
  SCO_BRA: { pHome: 0.1330, pDraw: 0.1823, pAway: 0.6847 },
  SCO_MAR: { pHome: 0.1759, pDraw: 0.2663, pAway: 0.5578 },
  SEN_IRQ: { pHome: 0.7186, pDraw: 0.1759, pAway: 0.1055 },
  SUI_BIH: { pHome: 0.5323, pDraw: 0.3333, pAway: 0.1343 },
  SUI_CAN: { pHome: 0.4483, pDraw: 0.2808, pAway: 0.2709 },
  TUN_JPN: { pHome: 0.1343, pDraw: 0.2338, pAway: 0.6318 },
  TUN_NED: { pHome: 0.0955, pDraw: 0.1558, pAway: 0.7487 },
...
export const MATCH_ODDS_FETCHED_AT = '2026-06-18T20:09:21.781Z';
