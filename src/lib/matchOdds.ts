...
//
// Last fetched: 2026-06-27T13:06:24.162Z
// Match markets: 45 / 99
 ...
 * 45 markets fetched on 2026-06-27T13:06:24.162Z.
 */
export const MATCH_ODDS: Record<string, MatchOdds> = {
  ARG_AUT: { pHome: 1.0000, pDraw: 0.0000, pAway: 0.0000 },
  ARG_CPV: { pHome: 0.8499, pDraw: 0.1143, pAway: 0.0358 },
  AUS_EGY: { pHome: 0.2935, pDraw: 0.3234, pAway: 0.3831 },
  ...
  BRA_JPN: { pHome: 0.5821, pDraw: 0.2438, pAway: 0.1741 },
  ...
  CIV_NOR: { pHome: 0.2537, pDraw: 0.2736, pAway: 0.4726 },
  ...
  FRA_SWE: { pHome: 0.7574, pDraw: 0.1634, pAway: 0.0792 },
  GER_CIV: { pHome: 1.0000, pDraw: 0.0000, pAway: 0.0000 },
  GER_PAR: { pHome: 0.7186, pDraw: 0.1859, pAway: 0.0955 },
  ...
  RSA_CAN: { pHome: 0.1675, pDraw: 0.2690, pAway: 0.5635 },
...
export const MATCH_ODDS_FETCHED_AT = '2026-06-27T13:06:24.162Z';
