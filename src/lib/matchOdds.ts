...
//
// Last fetched: 2026-06-21T02:34:40.835Z
// Match markets: 38 / 99
 ...
 * 38 markets fetched on 2026-06-21T02:34:40.835Z.
 */
export const MATCH_ODDS: Record<string, MatchOdds> = {
  ...
  ECU_GER: { pHome: 0.2637, pDraw: 0.2537, pAway: 0.4826 },
  ENG_GHA: { pHome: 0.7931, pDraw: 0.1429, pAway: 0.0640 },
  ESP_CPV: { pHome: 0.0000, pDraw: 1.0000, pAway: 0.0000 },
  ESP_KSA: { pHome: 0.8815, pDraw: 0.0847, pAway: 0.0339 },
  ...
  TUN_JPN: { pHome: 0.1144, pDraw: 0.2040, pAway: 0.6816 },
  TUN_NED: { pHome: 0.0754, pDraw: 0.1558, pAway: 0.7688 },
...
export const MATCH_ODDS_FETCHED_AT = '2026-06-21T02:34:40.835Z';
