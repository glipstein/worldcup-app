...
//
// Last fetched: 2026-06-13T13:22:33.889Z
// Match markets: 38 / 99
 ...
 * 38 markets fetched on 2026-06-13T13:22:33.889Z.
 */
export const MATCH_ODDS: Record<string, MatchOdds> = {
  ...
  AUT_JOR: { pHome: 0.7241, pDraw: 0.1724, pAway: 0.1034 },
  BEL_EGY: { pHome: 0.5961, pDraw: 0.2414, pAway: 0.1626 },
  BEL_IRN: { pHome: 0.6881, pDraw: 0.1931, pAway: 0.1188 },
  BIH_QAT: { pHome: 0.5821, pDraw: 0.2537, pAway: 0.1642 },
  BRA_MAR: { pHome: 0.5764, pDraw: 0.2512, pAway: 0.1724 },
  ...
  ESP_KSA: { pHome: 0.8866, pDraw: 0.0743, pAway: 0.0391 },
  ...
  MAR_HAI: { pHome: 0.7214, pDraw: 0.1741, pAway: 0.1045 },
  ...
  QAT_SUI: { pHome: 0.0589, pDraw: 0.1337, pAway: 0.8073 },
  SCO_BRA: { pHome: 0.1429, pDraw: 0.1921, pAway: 0.6650 },
  SCO_MAR: { pHome: 0.2239, pDraw: 0.2836, pAway: 0.4925 },
  SEN_IRQ: { pHome: 0.6847, pDraw: 0.2020, pAway: 0.1133 },
  SUI_BIH: { pHome: 0.6089, pDraw: 0.2327, pAway: 0.1584 },
...
export const MATCH_ODDS_FETCHED_AT = '2026-06-13T13:22:33.889Z';
